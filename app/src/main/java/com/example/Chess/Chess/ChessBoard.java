...
public class ChessBoard {
    ...
    /**
     * The id of the chessPiece into the chessPiece array as its position on the
     * board will probably not match the position in the array
     */
    public static int[] chessPieceIds;
    /**
     * Ids we can use when a piece is "destroyed" or when we want to add another
     * piece
     */
    ...
    /**
     * Will take in a position and return an index into a array based on
     * positions (chessPieceIds)
     *
    ...
    /**
     * Will get the chess piece at the position specified in a range of 0-7 and
     * 0-7
     *
     * @param pos the position in a range of 0-7 x and 0-7 y
     * @return will return the chess piece or an empty piece if it is out of
    ...
    /**
     * Gets the id of a chess piece at the position, use to access a piece in
     * the chessPiece array
     *
     * @param pos the position to set it at
    ...
    /**
     * Adds a piece onto the board, will do nothing if it's not a valid spot to
     * add a piece
     *
     * @param piece the chessPiece to add with accept anything that implements
    ...
    /**
     * Will set a piece on the position to empty effectively "deleting it" This
     * should not be run while a piece is being updated
     *
