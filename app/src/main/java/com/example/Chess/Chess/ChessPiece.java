...
public abstract class ChessPiece {
     ...
     */
    // Modify SetToPosition to increment move count
    ...
    /**
     * Will get the image location for the piece. Is abstract so each specific
     * piece has its own implementation and can be used here
     *
    ...
    /**
     * Tries to move a piece to a position with its rules implemented in its
     * class
     *
    ...
    /**
     * Checks in a direction from a position to a wanted position, if there is a
     * piece of a border of the chess board
     *
     ...
     * @return the number of checks it has done (can be multiplied by direction
     * to get the final position it landed on), Will be 0 if we cannot move at
     * all
     */
    ...
    /**
     * Will try to take a piece at a position THIS WILL NEED TO BE CALLED BEFORE
     * SETTING THE POSITION OF THE PIECE IF TAKING A PIECE
     *
     * TryTakePiece(pos) SetToPosition(pos)
     *
     * NOT
     *
     * SetToPosition(pos) TryTakePiece(pos)
     *
